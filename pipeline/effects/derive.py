...
SEQUENCES: dict[str, dict] = {
    ...
    "titans-cleave": {
        ...
        "pivot": (8, 16),
        "frames": [
            (lambda s: sweep(scale(s, 1.15), (8, 16), -72, -18), 80),
            (lambda s: sweep(scale(s, 1.15), (8, 16), -42, 28), 80),
            (lambda s: sweep(scale(s, 1.15), (8, 16), -12, 72), 80),
            (lambda s: fade(scale(s, 1.25), 2), 90),
        ],
    },
    "comet-fall": {
        "still_key": "comet-fall",
        "anchor": "strike_target",
        "anchor_dx": 0,
        "align_to": "impact_expected",
        "cue_frame": 0,
    ...
    "radiant-bulwark": {
        "still_key": "radiant-bulwark",
        "anchor": "band",
        "anchor_dx": 0,
        "align_to": "impact_expected",
        "cue_frame": 3,
        "frames": [
            (lambda s: band(s, 22, 29), 80),
            (lambda s: band(s, 16, 29), 80),
            (lambda s: band(s, 8, 29), 80),
            (lambda s: band(s, 0, 29), 80),
            (lambda s: fade(band(s, 0, 29), 1), 70),
        ],
    },
    "solar-verdict": {
        "still_key": "solar-verdict",
        "anchor": "lane_travel",
        "anchor_dx": 0,
        "align_to": "release_projectile",
        "cue_frame": 0,
