...
FAMILIES: tuple[IconFamily, ...] = (
    ...
    # Talent / Ability Talent — Hunter Tier 3 one-variant glyphs (#612).
    # Empty recolor; iconKey equals content id.
    IconFamily(
        "master-fletcher",
        _subset(
        ...
        (IconVariant("master-fletcher", {}),),
        "master-fletcher/source.grid",
    ),
    IconFamily(
        "trailhardened",
        _subset(
        ...
        (IconVariant("trailhardened", {}),),
        "trailhardened/source.grid",
    ),
    IconFamily(
        "death-rain",
        _subset(
        ...
        (IconVariant("death-rain", {}),),
        "death-rain/source.grid",
    ),
    IconFamily(
        "killshot",
        _subset(
        ...
        (IconVariant("killshot", {}),),
        "killshot/source.grid",
    ),
