...
**Management Dock**:
The single 480×336 logical-pixel tabbed panel, exactly the Battle Tile's width, docked flush above the tile (below it when top-parked). It shows one management surface at a time — Party, Loadout, Talents, Armory, or Stage — and opening or switching it never resizes, moves, or pauses the Battle Tile.
