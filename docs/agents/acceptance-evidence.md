...
| Armory item-detail popover (worn strip and action-pane anchors; item stats without compare delta) | `evidence: armory-item-detail-popover` | `e2e/scenarios/armory.spec.ts` via `npm run test:evidence` |
