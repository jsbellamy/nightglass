...
describe("validateContent", () => {
  ...
  it("validates Stage 7 encounter budget when wave and boss xp totals match authored budget", () => {
    ...
    const bossOpponent = {
      ...
      family: "test",
      boss: true,
      base: { maxHealth: 200, physical: 12, spell: 0, armor: 10, elementalResistance: 10, firePower: 0, frostPower: 0, lightningPower: 0, lightPower: 0, critChance: 0.05, critDamage: 1.5 },
    ...
    const content: Content = {
      ...
      opponents: [
        ...fixtureContent.opponents,
        {
          ...
          family: "test",
          boss: true,
          base: { maxHealth: 500, physical: 20, spell: 0, armor: 15, elementalResistance: 15, firePower: 0, frostPower: 0, lightningPower: 0, lightPower: 0, critChance: 0.05, critDamage: 1.5 },
          abilityIds: ["boss-smash"],
          xpAward: 1500,
