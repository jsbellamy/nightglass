...
export const fixtureContent: Content = {
      ...
      talents: {
        statRow: [
          ...
          },
          {
            id: "p-blessing",
            name: "Blessing",
            perRank: { percent: { spellPower: 0.04 } },
            maxRanks: 5,
            iconKey: "p-blessing",
          },
        ],
  ...
  opponents: [
    ...
    },
    {
      ...
      family: "test",
      boss: false,
      base: { maxHealth: 25, physical: 5, spell: 0, armor: 2, elementalResistance: 2, firePower: 0, frostPower: 0, lightningPower: 0, lightPower: 0, critChance: 0.05, critDamage: 1.5 },
      abilityIds: ["grunt-attack"],
      xpAward: 10,
    ...
    },
    {
      ...
      family: "test",
      boss: false,
      base: { maxHealth: 50, physical: 6, spell: 0, armor: 3, elementalResistance: 3, firePower: 0, frostPower: 0, lightningPower: 0, lightPower: 0, critChance: 0.05, critDamage: 1.5 },
  ...
  affixBands: [
    ...
    { id: "flat-spell", tier1: [1, 3], tier2: [2, 5] },
    { id: "percent-spell-power", tier1: [0.02, 0.04], tier2: [0.03, 0.06] },
    { id: "flat-fire", tier1: [1, 3], tier2: [2, 5] },
    { id: "percent-fire-power", tier1: [0.02, 0.04], tier2: [0.03, 0.06] },
    { id: "flat-frost", tier1: [1, 3], tier2: [2, 5] },
    { id: "percent-frost-power", tier1: [0.02, 0.04], tier2: [0.03, 0.06] },
    { id: "flat-lightning", tier1: [1, 3], tier2: [2, 5] },
    { id: "percent-lightning-power", tier1: [0.02, 0.04], tier2: [0.03, 0.06] },
    { id: "flat-light", tier1: [1, 3], tier2: [2, 5] },
    { id: "percent-light-power", tier1: [0.02, 0.04], tier2: [0.03, 0.06] },
    ...
    { id: "flat-crit-chance", tier1: [2, 4], tier2: [4, 7] },
    { id: "flat-crit-damage", tier1: [5, 10], tier2: [10, 17] },
  ],
};
