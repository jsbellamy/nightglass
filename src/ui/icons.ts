...
export const ICON_SOURCES = {
  ...
  "red-beacon-token": {
    url: redBeaconTokenUrl,
    width: CONTENT_ICON_SIZE,
    height: CONTENT_ICON_SIZE,
  },
  "roadside-reliquary": {
    url: roadsideReliquaryUrl,
    width: CONTENT_ICON_SIZE,
    height: CONTENT_ICON_SIZE,
  },
