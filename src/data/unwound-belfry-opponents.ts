...
export const unwoundBelfryOpponents: OpponentDef[] = [
  ...
  tickmoth("tickmoth-s7-20", TICKMOTH_S7_STATS, 20),
  tickmoth("tickmoth-s8-38", TICKMOTH_S8_STATS, 38),
  tickmoth("tickmoth-s8-19", TICKMOTH_S8_STATS, 19),
  tickmoth("tickmoth-s9-60", TICKMOTH_S9_STATS, 60),
  tickmoth("tickmoth-s9-52", TICKMOTH_S9_STATS, 52),
  tickmoth("tickmoth-s9-30", TICKMOTH_S9_STATS, 30),
  tickmoth("tickmoth-s9-26", TICKMOTH_S9_STATS, 26),

  tollbat("tollbat-s7-44a", TOLLBAT_S7_STATS, 44),
  tollbat("tollbat-s7-44b", TOLLBAT_S7_STATS, 44),
  tollbat("tollbat-s7-20", TOLLBAT_S7_STATS, 20),
  tollbat("tollbat-s8-47a", TOLLBAT_S8_STATS, 47),
  tollbat("tollbat-s8-47b", TOLLBAT_S8_STATS, 47),
  tollbat("tollbat-s8-24", TOLLBAT_S8_STATS, 24),
  tollbat("tollbat-s8-19", TOLLBAT_S8_STATS, 19),
  tollbat("tollbat-s9-60", TOLLBAT_S9_STATS, 60),
  tollbat("tollbat-s9-30", TOLLBAT_S9_STATS, 30),
  tollbat("tollbat-s9-26", TOLLBAT_S9_STATS, 26),
  ...
  astrolabeSpider("astrolabe-spider-s8-19", SPIDER_S8_STATS, 19),
