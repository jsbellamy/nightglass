...
export const effectRecipes: Record<string, EffectRecipe> = {
  ...
  "titans-cleave": {
    stillKey: "titans-cleave",
    frames: "titans-cleave",
    anchor: "strike_target",
    anchorDx: -15,
    durationMs: 330,
  ...
  "glacial-prison": {
    stillKey: "glacial-prison",
    frames: "glacial-prison",
    anchor: "strike_target",
    durationMs: 260,
    cuesMs: { impact_expected: 700 },
  },
  ...
  "radiant-bulwark": {
    stillKey: "radiant-bulwark",
    frames: "radiant-bulwark",
    anchor: "band",
    durationMs: 390,
    cuesMs: { impact_expected: 700 },
  },
  "solar-verdict": {
    stillKey: "solar-verdict",
    frames: "solar-verdict",
    anchor: "lane_travel",
    durationMs: 100,
    cuesMs: { release_projectile: 850 },
  },
